...
export const TOOL_FRIENDLY_NAME_KEYS: Record<string, TranslationKeys> = {
  ...
  search: 'com_ui_tool_name_web_search',
  fetch_content: 'com_ui_voice_tool_fetch_content',
  get_current_time: 'com_ui_voice_tool_current_time',
  convert_time: 'com_ui_voice_tool_convert_time',
