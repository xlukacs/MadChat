...
let OpenIDStrategy;
/** @type {ReturnType<typeof createCustomOpenIDStrategy> | null} */
...
const setupOpenIdAdmin = (openidConfig) => {
  try {
    ...
    if (!CustomOpenIDStrategy) {
      throw new Error('CustomOpenIDStrategy not initialized');
    }
...
async function setupOpenId() {
  try {
    ...
    CustomOpenIDStrategy = createCustomOpenIDStrategy();
